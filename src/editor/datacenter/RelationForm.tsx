...
export function RelationForm({ relation, onClose }: RelationFormProps) {
  ...
  function save() {
    ...
    // The slots of a load relation live only here; they stay while they still fit.
    ...
    const data: Omit<RelationTemplate, 'id'> = {
      ...
      ...(positions && syntax.verb === 'GET_RELATION' && positions.slots.length === syntax.parameter.length
        ? { positions }
        : {}),
    }
