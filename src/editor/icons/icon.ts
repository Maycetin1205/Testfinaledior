...
export const ChevronUp = iconFactory('chevron-up', NODE.ChevronUp)
...
export const MousePointer2 = iconFactory('mouse-pointer-2', NODE.MousePointer2)
export const MousePointerClick = iconFactory('mouse-pointer-click', NODE.MousePointerClick)
...
export const Wand2 = iconFactory('wand-sparkles', NODE.Wand2)
