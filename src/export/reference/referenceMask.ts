...
const CHAIN: Step[] = [
  ...
  { id: 's2', kind: 'START_TOOL', resultName: '', toolNr: '42', toolParameter: ['a b'] },
  ...
  const tree: MaskTree = {
    ...
    t1: node('t1', 'capture', ROOT_ID, {
      ...
      calculations: [{
        key: 'b1',
        name: 'Doppelt',
        lead: { kind: 'column', key: 'f0', column: 'sp-doppelt', unit: 'count', result: true, round: { spots: 2, direction: 'kfm' } },
        numerator: [
          { kind: 'column', key: 'f1', column: 'sp-menge', unit: 'count', result: false, round: { spots: 3, direction: 'kfm' } },
